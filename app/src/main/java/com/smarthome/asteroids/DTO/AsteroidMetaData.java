...
public class AsteroidMetaData
{
    ...
    private List<Close_approach_data> close_approach_data;
    ...
    public List<Close_approach_data> getClose_approach_data ()
    {
        return close_approach_data;
    }

    public void setClose_approach_data (List<Close_approach_data> close_approach_data)
    {
    ...
    {
        return "ClassPojo [estimated_diameter = "+estimated_diameter+", neo_reference_id = "+neo_reference_id+", nasa_jpl_url = "+nasa_jpl_url+", is_potentially_hazardous_asteroid = "+is_potentially_hazardous_asteroid+", orbital_data = "+orbital_data+", is_sentry_object = "+is_sentry_object+", name = "+name+", absolute_magnitude_h = "+absolute_magnitude_h+", links = "+links+", id = "+id+", designation = "+designation+", close_approach_data = "+close_approach_data+"]";
    }
}